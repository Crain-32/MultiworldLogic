...
from logic.gameitem import GameItem, junk_item_check
from logic.itempool import generate_game_item_pool, generate_starting_items, dungeons
from logic.location import Location
from logic.requirements import Macro, Requirement
...
class World:
    ...
    def determine_chart_mappings(self, random_state):
        ...
        if self.world_settings.randomize_charts:
            random_state.shuffle(chart_mappings)
    ...
    def determine_race_mode_dungeons(self, random_state: Random):
        if self.world_settings.race_mode:
            ...
            random_state.shuffle(shuffled_dungeons)
    ...
    def load_world(self, world_file_path: str, macros_file_path: str):
        self.area_entries = World.load_parse_world(world_file_path, self.world_id)
        self.macros = {macro.name: macro for macro in World.load_parse_macros(macros_file_path)}
